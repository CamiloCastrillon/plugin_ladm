...
def verificar_y_generar_reporte(capa_terrenos, capa_limite_urbano, capa_limite_municipio, ruta_reporte):
    ...
    for feature in capa_terrenos.getFeatures():
        numero_predial = feature["Numero_Predial"]
